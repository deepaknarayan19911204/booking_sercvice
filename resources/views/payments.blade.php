                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <ul class="nav nav-tabs customtab" role="tablist">
                                ...
                                <li class="nav-item"> <a class="nav-link"  href="{{url('/services')}}" role=""><span class="hidden-sm-up"><i class="ti-user"></i></span> <span class="hidden-xs-down">Services</span></a> </li>
                                <li class="nav-item"> <a class="nav-link active" href="{{url('/payments')}}" role=""><span class="hidden-sm-up"><i class="ti-email"></i></span> <span class="hidden-xs-down">Payments</span></a> </li>
                            </ul>
                            <!-- Tab panes -->
                        ...
                        <div class="">
                            @foreach ($requestorders as $order)
                                <div class="card card-body wizard-content">
                                    ...
                                    <form action="{{ route('requestsupdate') }}" method="POST" enctype="multipart/form-data" class="tab-wizard wizard-circle">
                                        @csrf
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="col-md-12 mt-5">
                                                    <h3 class=""><i>Service is complete, Please confirm payment amount:</i></h3>
                                                    <h3 class=""><i class="mdi mdi-beaker"></i> Invoice item:</h3>
                                                    <h3 class=""><i class="mdi mdi-av-timer"></i> Session Price : {{ $order->price }} </h3>
                                                </div>
                                                <div class="col-md-12">
                                                    <button type="button" class="btn waves-effect waves-light btn-secondary">Start a chat</button>
                                                    <button type="submit" class="btn waves-effect waves-light btn-primary">Resend Invoice</button>
                                                </div>
                                            </div>
                                        </section>
                                        <!-- Step 4 -->
