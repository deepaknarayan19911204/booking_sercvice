                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <ul class="nav nav-tabs customtab" role="tablist">
                                <li class="nav-item"> <a class="nav-link active" href="{{url('/requests')}}" role=""><span class="hidden-sm-up"><i class="ti-home"></i></span> <span class="hidden-xs-down">Requests</span></a> </li>
                                    ...
                                    <form action="{{ route('requestsupdate') }}" method="POST" enctype="multipart/form-data" class="tab-wizard wizard-circle">
                                        ...
                                        <section>
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    <button type="button" class="btn waves-effect waves-light btn-secondary">Reschedule</button>
                                                    <button type="submit" class="btn waves-effect waves-light btn-primary">Accept Request</button>
                                                </div>
                                            </div>
                                        </section>
                                        <!-- Step 2 -->
